...
import MyContext from "../MyContext"; // 생성한 Context 가져오기
...
function MainPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("DOMMouseScroll", wheelHandler, { once: true });
    window.addEventListener("mousewheel", wheelHandler, { once: true });
